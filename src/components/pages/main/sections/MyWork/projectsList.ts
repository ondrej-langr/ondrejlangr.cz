...
export default [
  {
    ...
    imageUrl: require('@public-files/work/larok.png'),
  },
  {
    title: 'Pohadkovyzamek',
    url: 'https://pohadkovy-zamek.cz/',
    tags: [Tags.eshop, Tags.webpage],
    imageUrl: require('@public-files/work/zamek.png'),
  },

  {
    ...
    tags: [Tags.eshop, Tags.webpage],
    imageUrl: require('@public-files/work/plantae.png'),
  },
  {
    title: 'Badadovolena',
    url: 'http://badadovolena.cz/hlavni/',
    tags: [Tags.webpage],
    imageUrl: require('@public-files/work/badadovolena.png'),
  },

  {
    ...
    imageUrl: require('@public-files/work/decorasi.png'),
  },
  {
    title: 'Svobodnilezci',
    url: 'https://www.svobodnilezci.com/',
    tags: [Tags.webpage, Tags.blog],
    imageUrl: require('@public-files/work/svobodni.png'),
  },

  {
    ...
    tags: [Tags.webpage],
    imageUrl: require('@public-files/work/pragaleto.png'),
  },
];
