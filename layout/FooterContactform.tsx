  ...
  return (
    <TitledSection title={"Pojďme si napsat!"} movingTitle={"Kontakt"}>
      <Wrap>
            ...
            <Form>
              ...
              <FormRow>
                ...
                <Field
                  ...
                  name="text"
                  required
                  placeholder="Ahoj Ondro, potřeboval bych něco..."
                />
                <Err
                  name="text"
                  component="div"
              ...
              <FormRow className="mt-14">
                <Button type="submit" disabled={isSubmitting}>
                  {isSubmitting ? <>Posílám...</> : <>Poslat zprávu</>}
                </Button>
              </FormRow>
              {sended && (
                <SendRes
        ...
        <ContactWrap>
          <address>
            <span>Ondřej Langr</span>
            <br />
            Lukavec u Hořic 13 <br />
            508 01 Hořice
          </address>
          <div className="my-5">
            <a href="tel:607445251">
              Tel.: <span>+420 607 445 251</span>
            </a>
            <br />
            <a href="mailto: hi@ondrejlangr.cz">
              Email : <span>hi@ondrejlangr.cz</span>
            </a>
            <br />
            <a href="https://www.linkedin.com/in/langr-ondrej/" target="_blank">
              Linkedin : <span>langr-ondrej</span>
            </a>
            <br />
          </div>
          <div>
